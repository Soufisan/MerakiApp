      ...
      <form className='formulario-registro'>
        ...
        <div className='div-input'>
          ...
          <input 
            ...
            onChange={handleChange}
            name='correo'
            placeholder='andrómaca@correo.com'
            id="email" 
            type="email" />
        </div>
        <div className='div-input'>
        ...
        <div className='div-btn'>
          <Boton ftn={register} aspecto="normal" nombre="Registrar"/>
          <Boton ftn={cancelarRegistro} aspecto="normal alerta" nombre="Cancelar"/>
        </div>
      </form>
    </div>
  )
